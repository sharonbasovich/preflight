# submission/ — what maps to which lablab form field

| lablab field | Where it lives | Status |
| --- | --- | --- |
| Project Title | "PreFlight" | ready |
| Short Description (≤255 ch) | see below | ready |
